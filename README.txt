...
INSTALLING
----------
1. To install the module copy the 'languageicons' folder to your sites/all/modules directory.
...
--------------------------------------------------------------------------
1. Go to the module issue queue at http://drupal.org/project/issues/languageicons?status=All&categories=All
